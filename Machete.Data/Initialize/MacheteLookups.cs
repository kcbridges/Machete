        ...
        private static List<Lookup> _cache = new List<Lookup>
            {
                ...
                new Lookup { ID=31, category = LCategory.maritalstatus, key=LMaritalStatus.Single,     text_EN = "Single", text_ES = "Individual", selected=true },
                new Lookup { ID=32, category = LCategory.maritalstatus, key=LMaritalStatus.Married,    text_EN = "Married", text_ES = "Casado", selected=false },
                new Lookup { ID=33, category = LCategory.maritalstatus, key=LMaritalStatus.Separated,    text_EN = "Separated", text_ES = "Separado", selected=false },
                new Lookup { ID=34, category = LCategory.maritalstatus, key=LMaritalStatus.Widowed,    text_EN = "Widow/Widower", text_ES = "Viuda/Viudo", selected=false },
                new Lookup { ID=35, category = LCategory.maritalstatus, key=LMaritalStatus.Divorced,    text_EN = "Divorced", text_ES = "Divorciado", selected=false },
